...
import { FIND_USERS } from "./Gql_user";
...
import {
  partnerExceptionDataInEditBtn,
  partnerExceptionDataInTable,
} from "./partnerControlData";
import Atm_PartnerForm from "./Atm_PartnerForm";
                  ...
                  {!["id"].includes(cell.column.id) && (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* 수정버튼 */}
                        {!partnerExceptionDataInEditBtn.includes(
                          cell.column.id
                        ) && (
                          <div
            ...
            {headerGroups.map((headerGroup, idx) => (
              <tr {...headerGroup.getHeaderGroupProps()} key={idx}>
                {headerGroup.headers.map(
                  (column, idx) =>
                    !partnerExceptionDataInTable.includes(column.id) && (

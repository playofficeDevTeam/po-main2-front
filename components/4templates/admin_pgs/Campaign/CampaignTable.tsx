...
import { DELETE_QUESTION_FOR_ADMIN } from "../Question/QuestionTable";
...
export default function App() {
  const [campaignForm, setQuestionForm] = useRecoilState(campaignFormData);
  ...
  ] = useMutation<deleteCampaign, deleteCampaignVariables>(

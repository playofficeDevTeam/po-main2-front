      ...
      <Layout>
        <Component {...pageProps} />
                ...
                <CookieConsent
                  ...
                  buttonStyle={{ color: "#4e503b", fontSize: "13px", marginRight: "110px"  }}
                  expires={150}
                >
        이 사이트는 사용자 경험을 향상시키기 위해 쿠키를 사용합니다.{" "}
        <span style={{ fontSize: "10px", cursor: "pointer" }} onClick={handleOpen}>더 알아보기</span>
      </CookieConsent>
...
>
  ...
  <Box sx={{ overflowY: 'auto', maxHeight: 'calc(80vh - 48px)', paddingRight:4, }}> {/* 스크롤 영역 추가 */}
